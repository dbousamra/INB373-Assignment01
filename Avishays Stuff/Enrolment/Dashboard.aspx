...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    Dashboards for <%# User.Identity.Name %>
    
    
    <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        
        DataKeyNames="id" DataSourceID="Students">
        <Columns>
            ...
            <asp:BoundField DataField="enrolment_type_id" HeaderText="enrolment_type_id" 
                SortExpression="enrolment_type_id" />
